...
function PhTower({ clipId }: { clipId: string }) {
  return (
    <g transform="translate(780 42)" className="hero-run__tower">
      ...
      <ellipse cx="80" cy="276" rx="78" ry="10" fill="#0B1F14" opacity="0.12" />
      ...
      <path
        ...
        strokeLinejoin="round"
      />
      <path d="M36 56 H124" stroke="#FFDF22" strokeWidth="4" />
      <rect x="70" y="250" width="20" height="22" rx="2" fill="#1CA350" />
    </g>
  );
}
...
function ShopBlock() {
  return (
    <g transform="translate(920 168)">
      ...
      <rect x="68" y="56" width="64" height="134" rx="4" fill="#FFDF22" />
...
function Palm({ x, y }: { x: number; y: number }) {
  return (
    <g transform={`translate(${x} ${y})`}>
      ...
      <path d="M22 44C4 28 2 8 12 4C18 22 22 28 22 44Z" fill="#1CA350" />
  ...
  return (
    <g className="hero-run__truck">
      <g transform="translate(40 328)">
        ...
        <rect x="24" y="36" width="148" height="4" fill="#FFDF22" />
        <rect x="168" y="22" width="52" height="36" rx="6" fill="#147A3E" />
        <path d="M214 22h12l16 18v18h-10c-4 0-7-3-8-7L214 22Z" fill="#0B1F14" />
