  ...
  return (
    <section id="how-it-works" className="mt-12 scroll-mt-20">
      ...
      <ol className="mt-6 grid gap-4 md:grid-cols-3">
        {BEATS.map((beat) => (
          <li key={beat.step} className={cn(cardClassName, "overflow-hidden p-0")}>
            <div className="relative h-36">
              ...
              <span className="absolute left-3 top-3 rounded-full bg-white/90 px-2 py-0.5 text-[11px] font-semibold tracking-wide text-ink">
                {beat.step}
              </span>
            </div>
